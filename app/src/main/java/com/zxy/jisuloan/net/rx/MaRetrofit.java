...
public class MaRetrofit {
    ...
    public MaRetrofit addJson(String key, JSONArray value) {
        try {
            getBaseJson().put(key, value);
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    public Retrofit addInterceptor() {
        ...
        client.addInterceptor(new Interceptor() {
            ...
            public okhttp3.Response intercept(Chain chain) throws IOException {
                ...
                MyLog.i("post",requests.url().toString());
                //记录请求耗时
                ...
                //使用前clone()下，避免直接消耗
                MyLog.i("post","response:" + buffer.clone().readString(Charset.forName("UTF-8")));
                return response;
            }
        });
        return retrofit;
    ...
    private Request setupRequestBody(Request oldRequests) {
        ...
        MyLog.i("requestBody-json", json.toString());
        //返回一个新的RequestBody
